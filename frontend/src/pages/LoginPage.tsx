  ...
  const subtitle = useMemo(
    () =>
      mode === 'login'
        ...
        : 'Нужны только имя, логин и пароль. Друзья увидят календарь после взаимной связи.',
    [mode],
  )
  ...
  return (
    <main className="login-page">
      ...
      <section className="public-hero" aria-label="О проекте «Время вместе»">
        ...
        <p>
          «Время вместе» помогает друзьям и небольшим командам видеть только взаимную занятость,
      ...
      <section className="public-preview" aria-label="Как выглядит планирование">
        ...
        <div>
          ...
          <p>
            Доступны регистрация, друзья, личные интервалы, общий поиск времени, предложения встреч,
